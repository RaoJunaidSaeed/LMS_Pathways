...
// import DescriptionForm from '@/components/courses/DescriptionForm';
// import PriceForm from '@/components/courses/PriceForm';
// import Category from '@/models/Category'; // Import Model
// import CategoryForm from '@/components/courses/CategoryForm';
// import ImageForm from '@/components/courses/ImageForm';
// import ChaptersForm from '@/components/courses/ChaptersForm';
// import Chapter from '@/models/Chapter';
...
//   const categoryOptions = categories.map((c) => ({
//     label: c.name,
//     value: c.name.toLowerCase(), // matches schema 'lowercase: true'
//   }));
//   let course = await Course.findOne({ _id: courseId, userId });
//   if (!course) return redirect('/teacher/courses');
...
//     course.price,
//     course.category,
//     course.chapters?.length > 0, // Check if at least one chapter exists
//   ];
...
//           <span className="text-sm text-slate-700">Complete all fields {completionText}</span>
//         </div>
//         {/* Publish Button Logic (Disabled until complete) */}
//         {/* We will add the actual Publish Action later */}
//         <button
//           disabled={!isComplete}
//           className="bg-black text-white px-4 py-2 rounded-md text-sm hover:bg-slate-800 disabled:opacity-50 disabled:cursor-not-allowed"
//         >
//           Publish
//         </button>
//       </div>
...
//           <TitleForm initialData={course} courseId={course._id.toString()} />

//           <DescriptionForm initialData={course} courseId={course._id.toString()} />

//           {/* Image Form Placeholder */}
//           <ImageForm initialData={course} courseId={course._id.toString()} />
...
//               <h2 className="text-xl font-semibold">Course chapters</h2>
//             </div>
//             <ChaptersForm initialData={course} courseId={course._id.toString()} />
//           </div>
...
//               <h2 className="text-xl font-semibold">Sell your course</h2>
//             </div>
//             <PriceForm initialData={course} courseId={course._id.toString()} />
//           </div>
...
//               <h2 className="text-xl font-semibold">Resources & Attachments</h2>
//             </div>
//             <div className="mt-6 border bg-slate-100 rounded-md p-4 text-center text-slate-500 italic">
//               No attachments yet. (File Upload Coming Soon)
//             </div>
//           </div>
//         </div>
//       </div>
