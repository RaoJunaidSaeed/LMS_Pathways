...
//   },
// ];
// const infiniteCourses = [...topCourses, ...topCourses, ...topCourses, ...topCourses];
...
//       <div className="relative w-[85%] md:w-[90%]  mask-gradient">
//         <div className="flex justify-center items-center animate-scroll whitespace-nowrap gap-6 w-max px-4">
//           {infiniteCourses.map((course, index) => {
//             const thumbnailUrl = getYouTubeThumbnail(course.videoLink, 'hq');
//             return (
//               <div
//                 key={`${course.id}-${index}`}
//                 className="w-72 group relative bg-white border border-gray-100 p-3 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer"
//               >
//                 <div className="h-40 w-full rounded-xl overflow-hidden relative mb-4 bg-gray-200">
//                   <img
//                     src={thumbnailUrl}
